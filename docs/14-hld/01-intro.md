...
|---------|-------|------------|
| [2. System Design Framework](./02-system-design-framework.md) | Structured approach, estimations, patterns | Foundation |
| [3. Design URL Shortener](./03-url-shortener.md) | bit.ly - ID generation, redirects, analytics | ⭐⭐ Easy |
| [4. Design Rate Limiter](./04-rate-limiter.md) | API protection, algorithms, distributed | ⭐⭐⭐ Medium |
| [5. Design Twitter Feed](./05-twitter-feed.md) | News feed, fanout, ranking | ⭐⭐⭐⭐ Hard |
| [6. Design Chat System](./06-chat-system.md) | WhatsApp/Slack - real-time messaging | ⭐⭐⭐⭐ Hard |
| [7. Design Notification System](./07-notification-system.md) | Push, email, SMS at scale | ⭐⭐⭐ Medium |
| [8. Design Distributed Cache](./08-distributed-cache.md) | Multi-level caching, consistency | ⭐⭐⭐⭐ Hard |
...
**Next:** [2. System Design Framework →](./02-system-design-framework.md)
